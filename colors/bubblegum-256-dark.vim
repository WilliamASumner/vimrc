...
hi CursorLineNr ctermfg=120 ctermbg=237 cterm=none guifg=#B2B2B2 guibg=#3A3A3A gui=none
...
hi NonText ctermfg=241 ctermbg=235 cterm=none guifg=#808080 guibg=#262626 gui=none
